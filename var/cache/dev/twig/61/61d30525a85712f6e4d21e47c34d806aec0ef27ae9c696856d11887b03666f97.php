...
class __TwigTemplate_ea54e9f86cd402bb413b1b4fe44d5784effc154f7e4fe7b3b0860a11beb0b4da extends Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "<div class = \"container-fluid col-8\">
<form method=\"post\">
    ";
        // line 8
    ...
    ";
        ...
        // line 17
        echo "
    <h3 class=\"font-weight-normal mt-3\">Se connecter</h3>
    ";
        // line 19
        echo twig_include($this->env, $context, "_flash_messages.html.twig");
        echo "
    <p>Pour vous connecter utiliser l'email suivant : \"manager@manager.com\" et le mot de passe suivant : \"manager\".</p>
    <p>Vous aurez accès à la partie admin (sauf l'ajout d'utilisateur).</p>
    ...
    <input type=\"email\" value=\"";
        ...
        echo "\" name=\"email\" id=\"inputEmail\" class=\"form-control col-8 mt-3\" required autofocus>
    <label class= \"mt-3\" for=\"inputPassword\">Mot de passe</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control col-8 mt-3\" required>
...
";
    ...
    {
        return array (  135 => 28,  127 => 23,  120 => 19,  116 => 17,  108 => 14,  105 => 13,  103 => 12,  100 => 11,  94 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<form method=\"post\">
    ...
    <p>Vous aurez accès à la partie admin (sauf l'ajout d'utilisateur).</p>
    <label class= \"mt-3\"for=\"inputEmail\">Email</label>
    <input type=\"email\" value=\"{{ last_username }}\" name=\"email\" id=\"inputEmail\" class=\"form-control col-8 mt-3\" required autofocus>
    <label class= \"mt-3\" for=\"inputPassword\">Mot de passe</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control col-8 mt-3\" required>
...
{% endblock %}
", "security/login.html.twig", "/var/www/html/projets/eLibrairie/eLibrairie/templates/security/login.html.twig");
    }
}
